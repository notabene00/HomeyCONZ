...
class AqaraWallSwitchSingleRocker extends Sensor {
	...
	fireEvent(number) {
		...
		this.log('aqara wall (single rocker) switch event (' + number + ') button: ' + tokens.buttonIndex + ', action: '+ tokens.action);
...
module.exports = AqaraWallSwitchSingleRocker
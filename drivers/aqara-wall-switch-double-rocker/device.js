...
class AqaraWallSwitchDoubleRocker extends Sensor {
	...
	fireEvent(number) {
		...
		this.log('aqara wall (double rocker) switch event (' + number + ') button: ' + tokens.buttonIndex + ', action: '+ tokens.action);
...
module.exports = AqaraWallSwitchDoubleRocker
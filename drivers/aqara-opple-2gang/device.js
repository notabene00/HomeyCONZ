...
class AqaraOpple2GangSwitch extends Sensor {
	...
	fireEvent(number) {
		...
		this.log('AqaraOpple2GangSwitch event (' + number + ') button: ' + tokens.buttonIndex + ', action: '+ tokens.action);
...
module.exports = AqaraOpple2GangSwitch
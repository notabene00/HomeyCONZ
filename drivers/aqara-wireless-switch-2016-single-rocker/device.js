...
class AqaraWirelessSwitchSingleRocker2016 extends Sensor {
	...
	fireEvent(number) {
		...
		this.log('aqara wireless (single rocker, 2016) switch event (' + number + ') button: ' + tokens.buttonIndex + ', action: '+ tokens.action);
...
module.exports = AqaraWirelessSwitchSingleRocker2016
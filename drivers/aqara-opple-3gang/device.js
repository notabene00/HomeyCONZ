...
class AqaraOpple3GangSwitch extends Sensor {
	...
	fireEvent(number) {
		...
		this.log('AqaraOpple3GangSwitch event (' + number + ') button: ' + tokens.buttonIndex + ', action: '+ tokens.action);
...
module.exports = AqaraOpple3GangSwitch
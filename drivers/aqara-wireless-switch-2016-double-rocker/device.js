...
class AqaraWirelessSwitchDoubleRocker2016 extends Sensor {
	...
	fireEvent(number) {
		...
		this.log('aqara wireless (double rocker, 2016) switch event (' + number + ') button: ' + tokens.buttonIndex + ', action: '+ tokens.action);
...
module.exports = AqaraWirelessSwitchDoubleRocker2016
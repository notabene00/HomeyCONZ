...
class AqaraWirelessSwitchDoubleRocker2018 extends Sensor {
	...
	fireEvent(number) {
		...
		this.log('aqara wireless (double rocker, 2018)  event (' + number + ') button: ' + tokens.buttonIndex + ', action: '+ tokens.action);
...
module.exports = AqaraWirelessSwitchDoubleRocker2018